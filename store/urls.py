...
from store.views import products_view, shop_view, products_page_view, cart_view, \
    cart_add_view, cart_del_view, coupon_check_view, delivery_estimate_view, cart_buy_now_view, cart_remove_view
...
urlpatterns = [
    ...
    path('cart/buy/<str:id_product>', cart_buy_now_view, name="cart_buy_now_view"),
    path('cart/remove/<str:id_product>', cart_remove_view, name="cart_remove_view")
]